...
static constexpr auto qt_meta_stringdata_ZN13ButtonHandlerE = QtMocHelpers::stringData(
    "ButtonHandler",
    "onButtonClicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ButtonHandlerE[] = {
...
Q_CONSTINIT const QMetaObject ButtonHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ButtonHandlerE.offsetsAndSizes,
    qt_meta_data_ZN13ButtonHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ButtonHandlerE_t,
        // Q_OBJECT / Q_GADGET
...
void *ButtonHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ButtonHandlerE.stringdata0))
