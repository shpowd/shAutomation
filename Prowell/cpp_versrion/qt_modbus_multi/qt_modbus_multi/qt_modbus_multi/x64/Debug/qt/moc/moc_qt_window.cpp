...
void qt_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->openCommSettingsWindow((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->openMonitoringWindow((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->connectToSlave((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->disconnectFromSlave((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 8: _t->readFromSlave((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 9: _t->updateStatus((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QModbusDevice::State>>(_a[2]))); break;
        default: ;
        }
    }
}
