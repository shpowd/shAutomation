...
static constexpr auto qt_meta_stringdata_ZN7qt_testE = QtMocHelpers::stringData(
    "qt_test"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7qt_testE[] = {
...
Q_CONSTINIT const QMetaObject qt_test::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7qt_testE.offsetsAndSizes,
    qt_meta_data_ZN7qt_testE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7qt_testE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<qt_test, std::true_type>
    >,
    nullptr
} };
...
void *qt_test::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7qt_testE.stringdata0))
