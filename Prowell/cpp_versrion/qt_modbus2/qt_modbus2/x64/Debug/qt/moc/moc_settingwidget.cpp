...
static constexpr auto qt_meta_stringdata_ZN13SettingWidgetE = QtMocHelpers::stringData(
    "SettingWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13SettingWidgetE[] = {
...
Q_CONSTINIT const QMetaObject SettingWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13SettingWidgetE.offsetsAndSizes,
    qt_meta_data_ZN13SettingWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13SettingWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *SettingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13SettingWidgetE.stringdata0))
