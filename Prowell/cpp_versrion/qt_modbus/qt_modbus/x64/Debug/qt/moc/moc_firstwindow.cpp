...
namespace {
struct qt_meta_tag_ZN11FirstWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11FirstWindowE = QtMocHelpers::stringData(
    "FirstWindow",
    "PushButtonClicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11FirstWindowE[] = {
...
Q_CONSTINIT const QMetaObject FirstWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11FirstWindowE.offsetsAndSizes,
    qt_meta_data_ZN11FirstWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11FirstWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *FirstWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11FirstWindowE.stringdata0))
