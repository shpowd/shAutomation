...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(516, 396);
        actionConnect = new QAction(MainWindow);
        actionConnect->setObjectName("actionConnect");
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/connect.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionConnect->setIcon(icon);
        actionDisconnect = new QAction(MainWindow);
        actionDisconnect->setObjectName("actionDisconnect");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/images/disconnect.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionDisconnect->setIcon(icon1);
        actionExit = new QAction(MainWindow);
        actionExit->setObjectName("actionExit");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/application-exit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        verticalSpacer = new QSpacerItem(20, 0, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Maximum);
        ...
        verticalSpacer_2 = new QSpacerItem(20, 0, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::MinimumExpanding);
        ...
        menu_Device->setObjectName("menu_Device");
        menuToo_ls = new QMenu(menuBar);
        menuToo_ls->setObjectName("menuToo_ls");
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Modbus Server", nullptr));
